    ...
    <div className="min-h-screen">
      <main className="relative z-10 mx-auto max-w-[650px] px-6 py-16 md:py-24 md:px-0">
        <div className="flex flex-col gap-6 text-foreground">
          ...
          {/* Post content */}
          <article className="prose prose-invert max-w-none prose-headings:font-serif prose-headings:text-primary prose-p:text-foreground prose-a:text-primary prose-a:underline prose-strong:text-foreground">
